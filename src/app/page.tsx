  ...
  return (
    <div className="min-h-screen pb-20 perspective-container relative">
      ...
      <motion.header
        ...
        className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-200/50 z-40"
      >
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className={`text-[10px] px-2 py-1 rounded-full transition-all ${showVideo ? "bg-black text-white" : "bg-gray-100 text-gray-400 hover:bg-gray-200"}`}
